...
const MainBox = ({data,setter,setLoader}) => {
    return(
        ...
        style={{cursor:"pointer",display:"flex",flexDirection:"column",padding:"10px",textAlign:"center",justifyContent:"center",alignItems:"center",width:"30%",height:"200px",margin:10,borderRadius:10,background:"white",border:"1px solid rgba(0,0,0,0.2)"}}>
